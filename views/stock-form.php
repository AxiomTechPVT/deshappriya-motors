        ...
        <div class="estimate-panel-body">
            ...
            <form method="post" action="index.php?page=admin&amp;section=<?= e($section) ?>&amp;id=<?= (int)$id ?>">
                ...
                <div class="estimate-form-section">
                    ...
                    <div class="stock-search-help">Search an existing part number or name to load its saved details. Type a new one to create a new item.</div>
                    <div class="row g-3">
                        <div class="col-6">
                            <label class="form-label" for="stock-part-code">Part No. *</label>
                            <input class="form-control" id="stock-part-code" name="part_code" list="stock-part-codes" value="<?= e($input['part_code']) ?>" placeholder="Search part number..." autocomplete="off" required>
                        ...
                        <div class="col-6"><label class="form-label">Category</label><input class="form-control" name="category" id="stock-category" value="<?= e($input['category']) ?>" placeholder="Filters"></div>
