...
<main class="invoice-receipt thermal-receipt">
    ...
    <section class="receipt-payment-highlight"><span>Amount Received</span><strong>Rs. <?= number_format((float)$payment['amount_applied'], 2) ?></strong><small><?= e(ucfirst($payment['payment_method'])) ?><?php if ((float)$payment['change_given'] > 0): ?> · Change Rs. <?= number_format((float)$payment['change_given'], 2) ?><?php endif; ?></small></section>
