...
{
    ensure_customers_table(); ensure_vehicles_table(); ensure_vehicle_columns(); $filters = vehicle_filters(); $errors = []; $input = vehicle_input_record($_POST);
    ...
    $total = vehicle_list($filters, true); $rows = vehicle_list($filters); $pages = max(1, (int) ceil($total / $filters['per_page'])); $customers = vehicle_customers(); $title = 'All Vehicles'; $section = 'vehicles';
    require __DIR__ . '/../includes/header.php'; require __DIR__ . '/../views/vehicles.php'; require __DIR__ . '/../includes/footer.php';
}
