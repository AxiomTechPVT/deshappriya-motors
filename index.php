...
if ($page === 'admin') {
    ...
    if ($user['role'] === 'cashier') {
        $cashierSections = ['customers', 'customers-add', 'vehicles', 'vehicles-add', 'jobcards-pending', 'jobcards-ongoing', 'jobcards-completed', 'estimates', 'invoices-mine', 'invoices', 'invoices-quick', 'invoices-view', 'invoices-thermal', 'invoices-payment', 'invoices-receipt', 'reports-payments', 'cashier-register', 'cashier-advance-requests', 'expenses', 'expenses-add', 'expenses-view', 'other-income', 'other-income-add', 'other-income-view', 'employees-advances', 'employees-attendance', 'stock', 'stock-low', 'stock-add', 'stock-view', 'stock-purchase-receipt', 'stock-restock', 'services', 'services-add', 'services-view', 'appointments', 'appointments-add', 'appointments-view', 'appointments-edit', 'appointments-delete'];
